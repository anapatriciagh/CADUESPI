 ...
 * @author Rubens
 */
public class TelaPesquisarMatriculaProfessor extends javax.swing.JInternalFrame {
    ...
    void Pesquisar() throws SQLException {
        ...
        if(!campoMatricula.getText().equals("")){
            ...
            principal.getTelaCadastrarMatriculaProfessor().preencherJtablePelaMatricula(matricula);
        }else{
            if(!campoCpf.getText().equals("")){
            principal.getTelaCadastrarMatriculaProfessor().preencherJtablePeloCPF(cpf);
            }else{
                principal.getTelaCadastrarMatriculaProfessor().preencherJtablePeloNome(nome);
            }
        ...
        principal.getTelaCadastrarMatriculaProfessor().atualizarTela();
        principal.fecharTelaPesquisarMatriculaProfessor();
     ...
     * @param principal
     */
    public TelaPesquisarMatriculaProfessor(Principal principal) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(TelaPesquisarMatriculaProfessor.class.getName()).log(Level.SEVERE, null, ex);
        }
