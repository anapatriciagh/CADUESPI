...
public class TelaPesquisar extends javax.swing.JInternalFrame {
    ...
    void Pesquisar() throws SQLException {
        ...
        if(!campoMatricula.getText().equals("")){
            ...
            principal.getTelaVisuallizarAlunos().preencherJtableAlunoPelaMatricula(matricula);
        }else{
            if(!campoCpf.getText().equals("")){
            principal.getTelaVisuallizarAlunos().preencherJtableAlunoPeloCpf(cpf);
            }else{
                principal.getTelaVisuallizarAlunos().preencherJtableAlunoPeloNome(nome);
            }   
        }
        principal.getTelaVisuallizarAlunos().atualizarTela();
        principal.fecharTelaPesquisar();
    }
     ...
     * @param principal
     */
    public TelaPesquisar(Principal principal) {
