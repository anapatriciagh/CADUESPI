 ...
 * @author Rubens
 */
public class TelaPesquisarDisciplina extends javax.swing.JInternalFrame {

    private Principal principal;

    void Pesquisar() throws SQLException {
        if (!campoNomeDisciplina.getText().equals("")) {
            String nomeDisciplina = campoNomeDisciplina.getText();
            principal.getTelaCadastrarDisciplina().listarDisciplina(nomeDisciplina);
        } else {
            if (!campoCodigoDisciplina.getText().equals("")) {
                int iDcurso = Integer.parseInt(campoCodigoDisciplina.getText());
                principal.getTelaCadastrarDisciplina().listarDisciplina(iDcurso);
            } else {
                principal.getTelaCadastrarCursos().zerarTabelaCursos();
            }
        }
        principal.getTelaCadastrarDisciplina();
        principal.getTelaCadastrarDisciplina().atualizarTela();
        principal.fecharTelaPesquisarDisciplina();
     ...
     * @param principal
     */
    public TelaPesquisarDisciplina(Principal principal) {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(campoCodigoDisciplina))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jLabel1)
                        .addGap(18, 18, 18)
                        .addComponent(campoNomeDisciplina, javax.swing.GroupLayout.PREFERRED_SIZE, 168, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(TelaPesquisarDisciplina.class.getName()).log(Level.SEVERE, null, ex);
        }
